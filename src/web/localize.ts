...
const SPORT_L10N: Record<string, SportL10n> = {
  ...
  esports: { de: 'E-Sport', syn: ['e-sport', 'esport', 'gaming', 'competitive gaming'] },
  digital_sports: { de: 'Digitaler Sport', syn: ['digital sport', 'digital sports', 'virtual', 'zwift', 'virtual cycling', 'virtual rowing'] },
  sim_racing: { de: 'Sim Racing', syn: ['sim racing', 'simracing', 'virtual racing', 'iracing'] },
  chess: { de: 'Schach', syn: [] },
