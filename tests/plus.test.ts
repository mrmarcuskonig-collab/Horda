// plus.test.ts — Horda Plus subscription billing end-to-end (organiser upgrade).
...
console.log('\n[plus] Horda Plus subscription → 0% fee');
...
ok('settings shows Horda Plus active + cancel', settings.includes('Horda Plus') && settings.includes('/plus/cancel') && settings.includes('Active'));
